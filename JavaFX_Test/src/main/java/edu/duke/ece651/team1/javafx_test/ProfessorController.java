...
public class ProfessorController {
    ...
    private void addProfessorButtonClicked(ActionEvent event) {
        try {
            FXMLLoader professorLoader = new FXMLLoader(getClass().getResource("/edu/duke/ece651/team1/javafx_test/Professor/add-professor-view.fxml"));
    ...
    private void removeProfessorButtonClicked(ActionEvent event) {
        try {
            FXMLLoader professorLoader = new FXMLLoader(getClass().getResource("/edu/duke/ece651/team1/javafx_test/Professor/remove-professor-view.fxml"));
            Parent root = professorLoader.load();
            Scene scene = new Scene(root);
    ...
    private void backProfessorPageButtonClicked(ActionEvent event) {
        try {
            FXMLLoader professorLoader = new FXMLLoader(getClass().getResource("/edu/duke/ece651/team1/javafx_test/Professor/professor-view.fxml"));
            Parent root = professorLoader.load();
            Scene scene = new Scene(root);
