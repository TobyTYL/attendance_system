...
/**
 * The StudentController class handles all student-related operations within the
 * application.
 * It interfaces with the StudentView for presenting options and capturing
 * input, and uses a RestTemplate to communicate with the server for data
 * persistence.
 */
public class StudentController {
    ...
    /**
     * Constructs a StudentController with the specified input reader and output
     * stream.
     * 
     * @param inputReader A BufferedReader to read user input.
     * @param out         A PrintStream for outputting text to the console.
     */
    public StudentController(BufferedReader inputReader, PrintStream out, int sectionId, int classId, String className,
            int studentId) {
    ...
    /**
     * Launches the student menu and processes user choices for various student
