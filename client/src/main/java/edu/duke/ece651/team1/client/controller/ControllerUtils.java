...
/**
 * The ControllerUtils class provides utility methods for making HTTP requests to the backend service.
 * It includes methods for executing GET, POST, and PUT requests using RestTemplate, and methods for
 * managing session tokens in request headers.
 */
