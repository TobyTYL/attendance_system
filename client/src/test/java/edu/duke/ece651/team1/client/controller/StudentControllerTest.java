...
//     private StudentMainMenuController studentController;
//     @Mock
...
//         studentController = new StudentMainMenuController(inputReader, out, sectionId, classId, className, studentId);
