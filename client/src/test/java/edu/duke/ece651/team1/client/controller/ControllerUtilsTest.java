...
//     @BeforeEach
//     void setUp() {
//         controllerUtils.restTemplate = restTemplate;
//     }
...
//         String result = controllerUtils.executeGetRequest(testUrl, responseType);
...
//                 .thenReturn(responseEntity);
//         controllerUtils.executePostPutRequest(testUrl, "requestBody", responseType, true);
...
//                 () -> controllerUtils.executeGetRequest(testUrl, responseType));
...
//                 .thenReturn(responseEntity);
//         controllerUtils.executePostPutRequest(testUrl, "requestBodyToUpdate", responseType, false);
...
//         Exception exception = assertThrows(RuntimeException.class,
//                 () -> controllerUtils.executePostPutRequest(testUrl, requestBody, responseType, false));
//         assertTrue(exception.getMessage().contains("Server error occurred"));
//     }
